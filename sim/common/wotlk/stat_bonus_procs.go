...
type ProcStatBonusEffect struct {
	...
	// The item's equip proc aura. When set, its server proc entry gives ProcChance, PPM and ICD.
	ProcSpellID int32
...
func init() {
	...
	newProcStatBonusEffect(ProcStatBonusEffect{
		...
		ID:          45286,
		AuraID:      65014,
		Bonus:       stats.Stats{stats.AttackPower: 1234, stats.RangedAttackPower: 1234},
		Duration:    time.Second * 10,
		Callback:    core.CallbackOnSpellHitDealt,
		ProcMask:    core.ProcMaskMeleeOrRanged,
		Outcome:     core.OutcomeCrit,
