...
1. **Death Knight** (G, done; facts in the INVESTIGATION):
   ...
   - The DK's summons carry 67561, not 61017: no melee hit, and only the permanent ghoul takes ArP
     (INVESTIGATION, Pets). Core needs a marker to tell them apart, which this item may add to
     `sim/core/pet.go`.
   - Gargoyle: 75% AP→SP.
...
11. **Tanks** (Prot Warrior, Prot Paladin (recorded), Bear, DK tank):
    ...
    - The DK's rune weapon mirrors the DK's white swings and every spellbook spell he lands
      ...
      glyph, so its Pestilence doesn't refresh diseases, where the sim's does.
