...
- **Open, for the user:**
  - Crafted items ignore their recipe, so the epic cuts and Nightmare Tear read tier 13. Gating on Timothy
    Jones' designs (quest 66015) would make them 15.
  - Venture Coin vendor items (Grizzly Hills dailies, about 19 low-ilvl blues) count as PvE at 13.
...
Known issue, for the next catalog change: `addHolderDrop` dedupes holders only among the first 4 it stores,
so "N creatures" source labels can overcount.
